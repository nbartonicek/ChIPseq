...
inPath="$homedir/projects/Chris/raw_files/ELF5/renamed/"
#inPath="/share/ClusterScratch/nenbar/MRTA/raw_files/arrayexpress/"
...
#out directory
outPath="$homedir/projects/Chris/project_results/"$projectname.$inType
