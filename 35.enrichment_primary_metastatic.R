...
pathway<-read.table("LumA_MET.txt",header=T)
pathway=pathway[,1]
pathways[["LumA_MET_DE"]]<-pathway
...
pdf(paste0(imageDir,"ER_Alist_MDSC_LUMMet.pdf"),width=12,height=6)
plotGseaTable(pathways[1:3], rank, fgseaRes, 
              gseaParam = 0.5)
dev.off()
